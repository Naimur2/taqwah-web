...
export default function ContactUs() {
    return (
        <section className="py-14 xl:py-20" id="contact-us">
            <div className="container mx-0 px-4 grid lg:grid-cols-2 gap-14 xl:gap-20">
                <div className="flex flex-col gap-6 xl:gap-10">
                    <div className="flex flex-col xl:gap-6">
                        <h1 data-aos="fade-up" className="h1">
                            Contact Us
                        </h1>
                        <h3
                            data-aos="fade-up"
                            className="font-mabry text-md xl:text-2xl font-medium"
                        >
                    ...
                    <p
                        data-aos="fade-up"
                        className="text-base xl:text-xl !font-light font-mabry"
                    >
